...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
	...
	private static final long serialVersionUID = -607520045;

	/**
	 * The reference instance of <code>project_plutos.schema_version</code>
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.installed_rank</code>.
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.version</code>.
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.description</code>.
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.type</code>.
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.script</code>.
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.checksum</code>.
	 */
	public final TableField<SchemaVersionRecord, Integer> CHECKSUM = createField("checksum", org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>project_plutos.schema_version.installed_by</code>.
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.installed_on</code>.
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.execution_time</code>.
	 */
	...
	/**
	 * The column <code>project_plutos.schema_version.success</code>.
	 */
	...
	/**
	 * Create a <code>project_plutos.schema_version</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>project_plutos.schema_version</code> table reference
	 */
